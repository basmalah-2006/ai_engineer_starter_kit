...
SHORT_LABELS = {
    "Baseline (Vector Only)": "Baseline",
    "With Re-ranker": "Re-ranker",
    "Hybrid Search (70% Vector + 30% BM25) 🏆": "Hybrid 🏆",
}

METHOD_BLURBS = {
    "Baseline (Vector Only)": "⚡ الأسرع — بحث دلالي فقط (top-3).",
    "With Re-ranker": "🎯 Cross-Encoder يعيد ترتيب top-10 → top-3 لدقة أعلى.",
    "Hybrid Search (70% Vector + 30% BM25) 🏆": "✅ الأدق — دمج بحث دلالي + كلمات مفتاحية ثم إعادة ترتيب.",
}
...
retriever = get_retriever(st.session_state.retrieval_method)
...
st.markdown(
    ...
    div[data-testid="stPopover"] {
        ...
        right: 3rem !important;     /* far right, aligned with the send button */
